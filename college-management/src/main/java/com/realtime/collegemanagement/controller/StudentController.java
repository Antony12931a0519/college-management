...
public class StudentController {
	...
	@RequestMapping(value = "/college/student/list",
	...
	@RequestMapping(value = "/college/student/add", 
			produces = "application/json",
	...
	@RequestMapping(value = "/college/student/update",
			produces = "application/json",
			consumes = "application/json", 
			method = { RequestMethod.PUT })
	@ResponseBody
	public Student updteStudent(@RequestBody StudentModel student) throws Exception
			{
	...
	@RequestMapping(value = "/college/student/update/{studentId}",
			produces = "application/json",
			consumes = "application/json", 
			method = { RequestMethod.PUT })
	@ResponseBody
	public Student updteStudentByStudentId(@RequestBody StudentModel student,@PathVariable("studentId") int studentId ) throws Exception
			{

		Student studentDeails = studentBO.updateStudentByStudentId(student, studentId);

		return studentDeails;

	}

	@RequestMapping(value = "/college/student/delete",
			produces = "application/json", 
			consumes = "application/json",
	...
	@RequestMapping(value = "/college/student/deleteById/{studentId}",
			produces = "application/json",
			method = { RequestMethod.DELETE })
	@ResponseBody
...
//			consumes = "application/json",
	...
	/*@RequestMapping(value = "/college/studentdetails", produces = "application/json", consumes = "application/json", method = { RequestMethod.GET })
	@ResponseBody
	public Student deleteStudentByMobile(@RequestParam("mobile") String mobile)
			throws Exception {
		return studentBO.getStudentByMobile(mobile);
	}*/
